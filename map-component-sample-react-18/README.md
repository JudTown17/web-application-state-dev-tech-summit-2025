...
## Known Issues
* The `@arcgis/map-components-react` npm package has been retired at version 4.32. For react application using react version 19 and higher, use the `@arcgis/map-components` npm package. Refer to the [get started with react](https://developers.arcgis.com/javascript/latest/get-started-react/) page for detailed instructions on using the package.
